...
Structured documentation for TimeWarp.Flexbox developers, organized by purpose and information flow.
...
**Flow Explanation:**
1. **Ubiquitous Language** - Defines the terms (Component, Renderer, State, etc.)
...
| ---------------------------------------- | -------------------- | ----------------------------------------- |
| Definition of a term (Component, Renderer) | Ubiquitous Language  | What is a "Component"? What is "Rendering"? |
| How a feature works                      | Reference            | Current component lifecycle               |
| Why something was designed a certain way | Design               | Declarative UI philosophy                 |
| What's coming next                       | Roadmap              | State management integration              |
| Coding conventions                       | Standards            | C# style guide                            |
| How to implement a feature               | Guides               | Building custom components                |
